...
setTimeout(() => { console.log("jojo te hackié") }, 15000);
...
<html>
  ...
  <body>
    ...
    <section class="section">
        ...
        <div class="columns">
            <div class="column"><button id="boton_imagen" class="button is-primary">Mostrar imagen</button></div>
            <div class="column"><span id="imagen_chewy"></span></div>
            <div class="column"><span id="imagen_chewy_greñudo"></span></div>
            <div class="column"><span id="imagen_chewy_enojado"></span></div>
